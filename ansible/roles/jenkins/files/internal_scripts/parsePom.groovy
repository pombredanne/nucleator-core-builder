...
*/
artifactory_host = "artifactory.build.47lining.com"
artifactory_port = "8081"
//jh = jenkins.getRootDir()
records = new XmlSlurper().parse(new File("../sample_projects/samplewebapp/pom.xml"))
...
//println "Matches: "+pattern.matcher("http://10.0.203.83:8081/artifactory/libs-release-local/com/47lining/nucleator/sample-webapp/1.0-SNAPSHOT/sample-webapp-1.0-20141215.215941-1.war").matches()
//
a_fact.results.each{
