...
export NUI_URL=http://jenkins.build.47lining.com:8080
export NUI_USER=admin
python ../internal_scripts/makeonejob.py ../jobs/beanstalk\ app/DeployAppRepo-java.xml $ApplicationType $ApplicationFlavor $ApplicationName $GitRepoPath $GitCredentials $PomPath